...
export const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    ...
    location: 'Washim',
    quote: 'We needed a patient appointment booking and prescription reminder system with WhatsApp alerts. Shrinath IT Solutions delivered beyond our expectations. Very professional, secure, and prompt technical support.',
    rating: 5,
    initials: 'RD',
    verified: true,
    date: 'Recent Client',
  },
  {
    id: 'test-5',
    name: 'Ganesh Patil',
    role: 'Krishi Seva & Seeds Distribution',
    location: 'Karanja Lad',
  ...
  },
  {
    id: 'test-6',
    name: 'Swapnil Joshi',
    role: 'Digital Services & Print Hub',
    location: 'Risod',
  ...
  },
  {
    id: 'test-7',
    name: 'Pooja Rathod',
    role: 'Competitive Exam Academy',
    location: 'Washim',
    quote: 'Designed our student test portal and responsive admission landing pages. The user experience is clean, mobile-friendly, and has boosted our online student enrollments significantly.',
    rating: 5,
    initials: 'PR',
    verified: true,
    date: 'Recent Client',
  },
  {
    id: 'test-8',
    name: 'Anand Kulkarni',
    role: 'Architect & Engineering Consultant',
    location: 'Washim',
    quote: 'Transformed our company branding and built an interactive project showcase website. We have successfully closed high-value commercial construction contracts through client leads received from the site.',
    rating: 5,
    initials: 'AK',
    verified: true,
    date: 'Recent Client',
